...
pub mod premac;
#[doc = "Unique ID 0"]
pub struct UNIQUEID0 {
    register: vcell::VolatileCell<u32>,
}
#[doc = "Unique ID 0"]
pub mod uniqueid0;
#[doc = "Unique ID 1"]
pub struct UNIQUEID1 {
    register: vcell::VolatileCell<u32>,
}
#[doc = "Unique ID 1"]
pub mod uniqueid1;
